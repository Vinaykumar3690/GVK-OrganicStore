...
<html>
<head>
	<title>GVK Organic Store | Contact </title>
			...
			<div class="row contact-grids agile-1 mb-5">
				<div class="col-sm-4 contact-grid agileinfo-6 mt-sm-0 mt-2">
					<div class="contact-grid1 text-center">
						...
						<p style="font-weight: bold;color:black;">GVK Organic Store
							<label style="font-weight: bold;color:black;">Shop No.9 Building No.98/2 DwarakapuriColony Punjagutta Hyderabad, 500082</label>
						</p>
					</div>
				</div>
				<div class="col-sm-4 contact-grid agileinfo-6 my-sm-0 my-4">
					<div class="contact-grid1 text-center">
						...
						<p style="font-weight: bold;color:black;"><a style="font-weight: bold;color:black;" href="tel:+91 7842813690">+(91) 7842813690</a>
...
<!-- 							<label>+(91) 121 122 000</label> -->
				...
				<div class="col-sm-4 contact-grid agileinfo-6">
					<div class="contact-grid1 text-center">
						...
						<p>
							<a style="font-weight: bold;color:black;" href="mailto:vinaykumarg3690@gmail.com">vinaykumarg3690@gmail.com</a>
						</p>
					</div>
				</div>
			</div>
